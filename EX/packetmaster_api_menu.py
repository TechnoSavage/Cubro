...
from packetmasterG14_rest import PacketmasterEX
...
def set_ip():
    ...
    fail_count = 0
    while fail_count < 3:
        address = input('What is the IP address of the Packetmaster you want to access?: ')
...
if __name__ == '__main__':
    ...
    def topmenu():
        ...
        try:
            print(f'\nOptions for {PACKETMASTER.model} at {ADDRESS} acting as user {USERNAME}')
    ...
    def manage():
        ...
        print(f'''\n{PACKETMASTER.model} at {ADDRESS} acting as user {USERNAME}
...
\nController Configuration Menu''')
    ...
    def ruleconfig():
        ...
        print(f'''\n{PACKETMASTER.model} at {ADDRESS} acting as user {USERNAME}
\nRule and Port Group Configuration Menu''')
        choice = input('''
