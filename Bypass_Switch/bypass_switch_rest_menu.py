...
"""Cubro Copper Bypass Switch REST API demo. Menu driven interface
...
def set_ip():
    ...
    fail_count = 0
    while fail_count < 3:
        address = moves.input('Enter the IP Address of the Bypass Switch you want to manage: ')
        try:
...
if __name__ == '__main__':
    ...
    def menu():
        ...
        print('''Make Selection:
                ...
                6 - Quit\n''')
        choice = moves.input('Enter the number of your selection: ')
